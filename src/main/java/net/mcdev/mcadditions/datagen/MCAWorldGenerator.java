...
public class MCAWorldGenerator extends FabricDynamicRegistryProvider {
    public MCAWorldGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
