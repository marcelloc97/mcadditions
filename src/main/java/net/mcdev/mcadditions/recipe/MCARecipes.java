...
import net.mcdev.mcadditions.recipe.custom.StringWoolRecipeHardcoded;
...
public class MCARecipes {
    // Serializers
    public static final StringWoolRecipeHardcoded.Serializer STRING_WOOL_RECIPE_SERIALIZER =
        Registry.register(
            Registries.RECIPE_SERIALIZER,
            new Identifier(MCAdditions.MOD_ID, "string_wool"),
            new StringWoolRecipeHardcoded.Serializer()
